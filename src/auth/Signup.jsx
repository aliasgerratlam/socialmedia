          ...
          <div className="max-w-xl lg:max-w-3xl">
            ...
            <form action="#" className="mt-8 grid grid-cols-6 gap-6">
              <div className="col-span-6 sm:col-span-3">
                ...
                <input type="text" id="FirstName" name="first_name" className="mt-1 w-full rounded-md border border-gray-300 p-3 bg-white text-sm text-gray-700 h-10 shadow-sm" />
              </div>
              ...
              <div className="col-span-6 sm:col-span-3">
                ...
                <input type="text" id="LastName" name="last_name" className="mt-1 w-full rounded-md border border-gray-300 p-3 bg-white text-sm text-gray-700 h-10 shadow-sm" />
              </div>
              ...
              <div className="col-span-6 sm:col-span-3">
                ...
                <input type="password" id="PasswordConfirmation" name="password_confirmation" className="mt-1 w-full rounded-md border border-gray-300 p-3 bg-white text-sm text-gray-700 h-10 shadow-sm" />
              </div>
